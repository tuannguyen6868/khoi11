...
?>
<?php
$page = "admin.php?go=history";
	$_SESSION['url']="admin.php?go=history";

	$sql="select * from hoadonban where TrangThai=2 order by SoHD Desc ";
...
?>
<body bgcolor="#999999">
<form name="formohis1" method="post" action="">
  <table width="500" border="1" align="center">
    <tr>
      <td colspan="8"><div align="center" class="style1">List Hoa Don Ban </div></td>
    </tr>
    <tr>
      <td height="35" colspan="2"><div align="center" class="style2">Action</div></td>
    ...
    <tr>
      <td><div align="center">
      </div>        <div align="center"></div>        <div align="center"><img src="adminimages/detail.png" width="16" height="16" border="0" onclick="location.href='admin.php?go=orderdetail&SoHD=<? echo($row['SoHD'])?>'"></div></td>
      <td width="64">
	  <?
				if($row['TrangThai']==0)
				{
			?>
	  <div align="center"><a href="admin.php?go=danhsachHD&action=delete&SoHD=<? echo($row['SoHD'])?>"><img src="adminimages/b_drop.png" width="16" height="16" border="0"></a> </div>
	  <?
				}else echo("|||");
			?>		
	  </td>
