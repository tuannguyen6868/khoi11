...
?>
<?php
$page = "admin.php?go=pending";
	$_SESSION['url']="admin.php?go=pending";

	$sql="select * from hoadonban where TrangThai = 0 order by SoHD Desc";
...
<form name="form1" method="post" action="">
  <table width="500" border="1" align="center">
	...
	?>
    <tr>
      <td colspan="9"><div align="center"><b style="color:#FF0000">Khong Co Hoa Don Nao Ca</b></div></td>
    </tr>
	<?
	}else{
